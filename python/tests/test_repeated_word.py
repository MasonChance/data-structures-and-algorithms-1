import pytest
from code_challenges.repeated_word.repeated_word import first_repeat

def test_first_repeat_short_str():
    short = 'Once upon a time, there was a brave princess who...'
    actual = first_repeat(short)
    expected = 'a'
    assert actual == expected


def test_first_repeat_para():
    ...
    actual = first_repeat(para)
    expected = 'it'
    assert actual == expected


def test_first_repeat_no_repeat():
    clear = 'I love this'
    actual = first_repeat(clear)
    expected = 'no repeated words found'
    assert actual == expected
